    ...
    public class MahuaModule : IMahuaModule
    {
        ...
        private class MyApiModule : Module
        {
            protected override void Load(ContainerBuilder builder)
            {
                ...
                _logger.Log(LogLevel.Debug, $"当前平台:{MahuaGlobal.CurrentPlatform}");
                ...
                //{
                    ...
                    builder.RegisterMahuaApi<SendLikeApiMahuaCommandHandler1, SendLikeApiMahuaCommand>(authorName);
